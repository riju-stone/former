    ...
    case "number":
      return (
        <input
          ...
          disabled={false}
          onChange={(e) => updateElementConstraint(elementId, validation.id, Number(e.target.value))}
        />
      );
    case "array":
      return (
        <select
          ...
          onChange={(e) => updateElementConstraint(elementId, validation.id, e.target.value)}
        >
